...
| [002](issues/002-market-day-lifecycle.md) | Market Day lifecycle (start, end, undo close) | AFK | 001 | open |
| [003](issues/003-admin-item-catalog.md) | Admin Item catalog (add, edit, retire) | AFK | 001 | open |
...
## Already in scaffold (not tracked)
